...
description: Configure your FluentCommunity essentials — community title, light and dark mode site logos, the default Open Graph image, and global post status.
---
...
The **Global Post Status** in FluentCommunity lets you display a post on the main portal for all members. You can **Disable** it from here by checking the checkbox if not needed.

![The Global Post Status option](/images/portal-settings/general-settings/Post-Status-4.webp)
