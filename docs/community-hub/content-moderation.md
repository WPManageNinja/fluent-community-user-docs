...
1.  A member clicks the **Report** option on a piece of content they believe is inappropriate.
...
For each reported item, you have several options:

* **Review Report:** View the details of the report, including who reported it and why.
* **Ignore Reports:** If you determine the content does not violate any rules, you can dismiss the report. The post or comment will remain visible.
* **Unpublish Post/Comment:** This action removes the content from public view in the feed. It is not permanently deleted and can be restored later if needed.
