...
description: Learn about the different user roles in FluentCommunity, such as Admin, Moderator, and Member, and how to assign them to manage your community effectively.
---
